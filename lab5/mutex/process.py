...
from constMutex import ENTER, RELEASE, ALLOW, ACTIVE, PING
        ...
        if _receive:
            ...
            if msg[2] == ENTER:
                ...
                if msg[1] not in self.working_processes:    #append process from message to working processes
                    print("Recieved PING from {} at {}".format(msg[1], self.process_id))
            ...
            #check for Activity on first timeout
            print("counter {} at process {}".format(self.counter, self.process_id))
            if self.counter == 1:   
                print("First Timeout at {} - send PING".format(self.process_id))
            ...
            if self.counter > 1:
                ...
                for item in self.queue:
                    #remove messages from crashed processes
